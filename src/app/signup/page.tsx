      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-2 border-foreground bg-card shadow-pixel">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold tracking-tighter">Create your Account</CardTitle>
            <CardDescription>Join QuestVerse and start your epic learning journey.</CardDescription>
          </CardHeader>
